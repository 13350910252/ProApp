...
public class WanHomeBannerAdapter extends BannerAdapter<BannerEntity, WanHomeBannerAdapter.HomeBannerViewHolder> {
    ...
    @Override
    public WanHomeBannerAdapter.HomeBannerViewHolder onCreateHolder(ViewGroup parent, int viewType) {
